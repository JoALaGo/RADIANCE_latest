...
function fillInElements(elementType, places, contentType, filter) {
    ...
    if (elementType == "schema" && contentType == "box") {
        database.forEach(element => {
            ...
            let layout = '<div class="col-12 content_box_column rule"><div class="row text-center rule"> <div class="col-7"><button  type="button" id="' + element.element_id + '" onclick="toggleType(' + element.element_id + ',' + "'schema'" + ')" class="btn ">' + element.element_name + '</button></div><div class="col-1" style="padding-left: 2px;padding-right: 2px;font-size: 0.7rem;top: 14px;position: relative;" title="Download JSON" onclick="downloadElement(' + "'schema'" + ',' + element.element_id + ')">JSON</div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/download.png" class="img-fluid" alt="Responsive image" width="70%" style="padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Download this element" onclick="downloadElement(' + "'schema'" + ',' + element.element_id + ')"></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="rawEditElement(' + "'schema'" + ',' + element.element_id + ')" data-bs-toggle="modal" data-bs-target="#raw_edit_modal"></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/clone.png" class="img-fluid" alt="Responsive image" width="100%" data-toggle="tooltip" data-placement="bottom" title="Clone this element" onclick="cloneFromStorage(' + "'schema'," + element.element_id + ')"></div><div class="col-1"style="padding-left:2px;padding-right:2px;"><img src="res/delete.svg" class="img-fluid" alt="Responsive image" width="70%" style="padding-top:10px min-width:20px;"data-toggle="tooltip" data-placement="bottom" title="Delete this element" onclick="deleteFromStorage(' + "'schema'," + element.element_id + ')"></div> </row> </div>';
    ...
    if (elementType == "profile" && contentType == "box") {
        database.forEach(element => {
            ...
            let layout = '<div class="col-12 content_box_column rule"><div class="row text-center rule"><div class="col-3" id="' + element.element_id + '_available_scores" style="margin-top:10px;"><div class="row rule"><div class="col rule" id="' + element.element_id + '_lowest_cs"></div><div class="col rule" style="font-size:smaller;">to</div><div class="col rule" id="' + element.element_id + '_highest_cs"></div></div></div> <div class="col-5"><button  type="button" id="' + element.element_id + '" class="btn " style="font-size:small;">' + element.element_name + '</button></div><div class="col-1" style="padding-left: 2px;padding-right: 2px;font-size: 0.7rem;top: 14px;position: relative;" data-toggle="tooltip" data-placement="bottom" title="Download JSON" onclick="downloadJSON(' + "'" + elementType + "'" + ',' + element.element_id + ')">JSON</div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="rawEditElement(' + "'" + elementType + "'," + element.element_id + ')" data-bs-toggle="modal" data-bs-target="#raw_edit_modal"></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/clone.png" class="img-fluid" alt="Responsive image" width="100%" data-toggle="tooltip" data-placement="bottom" title="Clone this element" onclick="cloneFromStorage(' + "'" + elementType + "'," + element.element_id + ')"></div><div class="col-1"style="padding-left:2px;padding-right:2px;"><img src="res/delete.svg" class="img-fluid" alt="Responsive image" width="70%" style="padding-top:10px;"data-toggle="tooltip" data-placement="bottom" title="Delete this element" onclick="deleteFromStorage(' + "'" + elementType + "'," + element.element_id + ')"></div> </row> </div>';
            //we fill the pertinent content boxes with the available schemas
        ...
        database.forEach(element => {
            ...
            let layout = '<div class="col-12 content_box_column"><div class="row text-center"> <div class="col-8"><button  type="button" id="' + element.element_id + '" class="btn ">' + element.element_name + '</button></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/download.png" class="img-fluid" alt="Responsive image" width="70%" style="padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Download this element" onclick="downloadElement(' + "'" + elementType + "'" + ',' + element.element_id + ')"></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="rawEditElement(' + "'" + elementType + "'," + element.element_id + ')" data-bs-toggle="modal" data-bs-target="#raw_edit_modal"></div><div class="col-1" style="padding-left:2px;padding-right:2px;"><img src="res/clone.png" class="img-fluid" alt="Responsive image" width="100%" data-toggle="tooltip" data-placement="bottom" title="Clone this element" onclick="cloneFromStorage(' + "'" + elementType + "'," + element.element_id + ')"></div><div class="col-1"style="padding-left:2px;padding-right:2px;"><img src="res/delete.svg" class="img-fluid" alt="Responsive image" width="70%" style="padding-top:10px;"data-toggle="tooltip" data-placement="bottom" title="Delete this element" onclick="deleteFromStorage(' + "'" + elementType + "'," + element.element_id + ')"></div> </row> </div>';
            //we fill the pertinent content boxes with the available schemas
            places.forEach(place => {
                //there is a filter in place
                if (filter != "" && element.element_name.includes(filter)) {
        ...
        database.forEach(element => {
            ...
            try {
                ...
                alertify.error('There is no test tube initialized');
            }
...
function buildTeacherUI(data) {
    ...
    console.log(from + "populating the teacher, prefetched level data: "); console.log(this.temporal_level_data);
    from = "buildTeacherUI: ";
    let button;
    ...
    var ui_variable_fields = { name, pseudonim, validating_expression_input, input_type, hide_variable, custom_html, custom_code, custom_value_load };
    ...
    for (let i in this.available_variables) {
        ...
        console.log(from + "populating the variable's fields: (" + i + "/" + this.available_variables.length + ") for variable: " + this.available_variables[i]);
        ...
        //console.log(ui_variable_fields);
    ...
    if (this.temporal_level_data != null && this.temporal_level_data.length != 0) {
        if (this.temporal_level_data.length != 0) {
            ...
            console.log(from + "there was an existing configuration found for this level, retrieving the existing data and updating the teacher with it.");



            //we fill in the data of the existing configuration into the UI
            for (let i in this.available_variables) {
                //There was an error here. The order of this.available_variables is not the same as the order in temporal_level_data. Therefore, we were missmatching the values with the dom elements that actually corresponded them.
                //alert("Current variable: "+this.available_variables[i]);
                let variable_config_location = null;
                for (let z in this.temporal_level_data) {
                    //we check the place of the current this.available_variables variable in the configurations stored by this.temporal_level_data

                    if (this.temporal_level_data[z].hasOwnProperty('name')) {
                        //this is a variable, NOT a category
                        if (this.temporal_level_data[z].name === this.available_variables[i]) {
                            variable_config_location = z;
                            break;//we found it and we are done populating its values.
                        }
                    }
                }

                if (variable_config_location != null) {

                    for (let x in variable_names) {
                        let document_element = document.getElementById(available_variables[i] + "_" + variable_names[x]);
                        if (x == 0) {
                            document_element.parentElement.insertAdjacentHTML('afterbegin', `<h5>Buscando en: ${this.available_variables[i]} valor para: ${variable_names[x]} que es: ${temporal_level_data[variable_config_location][variable_names[x]]}</h5>`);
                        }

                        document_element.className.includes("form-check-input") ? document_element.checked = temporal_level_data[i][variable_names[x]] : document_element.value = this.temporal_level_data[variable_config_location][variable_names[x]];

                    }
                } else {
                    alertify.error('No stored configuration for variable: ' + this.available_variables[i]);
                }
...
function populateParents() {
    ...
    for (let i in this.available_parents) {
        ...
        if (this.available_parents[i][2] == 'array') {
            if_array = '<div class="col-sm-2" style="z-index:2;"><a class="instance_add" style="margin-left:auto;margin-right:auto;" data-toggle="tooltip" data-placement="bottom" title="Add an instance " onclick="createInstanceFromProfileElement(' + "'test'" + ',' + "'available_children'" + ',' + i + ',' + i + ',1)")"><strong>+</strong></a></div>';
                        ...
                        if (this.temporal_level_data.length !== 0) {
                            ...
                            if (configuration.hide_category) {
                                ...
                                for (let y in sub_sets[x].variables) {
                                    //variable_name,dom_target,current_value,is_variable_subset,parent_index,instance_id,is_instance,type,subset_name
                                    console.log("Fetching custom input for " + y + " With the stored value: " + sub_sets[x].variables[y]);
                                    showVariableInput(y, subset_dom_id + '_accordion_body', sub_sets[x].variables[y], true, parent_index, instance_id, true, 3, subset_original_name);
                                }
                            }
                            ...
                            for (let y in sub_sets[x].variables) {
                                //variable_name,dom_target,current_value,is_variable_subset,parent_index,instance_id,is_instance,type,subset_name
                                console.log("Fetching custom input (2) for " + sub_sets[x].variables);
                                showVariableInput(y, subset_dom_id + '_accordion_body', sub_sets[x].variables[y], true, parent_index, instance_id, false, 3, subset_name);
                            }
    ...
    switch (type) {
        ...
        case 2: {
            ...
            for (let x of this.available_parents[self_index][4]) {
                //This fragment of code is used mostly for the instances of cycles.
                ...
                dom_target_element.innerHTML += '<div class="accordion-item"><h2 class="accordion-header shadow-sm content_box_option" id="in' + x.inner_id + '_header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#in' + x.inner_id + '_accordion" aria-expanded="false" aria-controls="in' + x.inner_id + '_header" onClick="populateChildren(' + self_index + ',' + self_index + ',' + x.inner_id + ',false,false)"  style=""><div class="row text-center" style=""><div class="col-sm-1" style="z-index:2;"><a class="instance_delete" style="margin-left:auto;margin-right:auto;" data-toggle="tooltip" data-placement="bottom" title="" onclick="deleteInstance(' + self_index + ',' + self_index + ',' + x.inner_id + ',false,false)" data-bs-original-title="Delete instance "><strong>-</strong></a></div></div><div class="col-sm-1"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="prepareInstanceForEdition(' + self_index + ',' + x.inner_id + ',' + "'" + x.Name + "'" + ');" data-bs-toggle="modal" data-bs-target="#raw_edit_instance_modal"></div><div class="col-sm-7">' + x.Name + '</div></button></h2><div id="in' + x.inner_id + '_accordion" class="accordion-collapse collapse" aria-labelledby="in' + x.inner_id + '_header"><div class="accordion-body" id="' + x.inner_id + '_accordion_body"><div class="d-flex flex-column" id="' + x.inner_id + '_accordion_children"></div></div></div></div>';
        ...
        case 3: {
            ...
            for (let x of this.available_parents[parent_index][4]) {
                ...
                dom_target_element.innerHTML += '<div class="accordion-item"><h2 class="accordion-header shadow-sm content_box_option" id="in' + x.inner_id + '_header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#in' + x.inner_id + '_accordion" aria-expanded="false" aria-controls="in' + x.inner_id + '_header" onClick="populateChildren(' + original_parent + ',' + self_index + ',' + x.inner_id + ',false,false)"  style=""><div class="row text-center" style=""><div class="col-sm-1" style="z-index:2;"><a class="instance_delete" style="margin-left:auto;margin-right:auto;" data-toggle="tooltip" data-placement="bottom" title="" onclick="deleteInstance(' + original_parent + ',' + self_index + ',' + x.inner_id + ',false,false)" data-bs-original-title="Delete instance"><strong>-</strong></a></div></div><div class="col-sm-1"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="prepareInstanceForEdition(' + parent_index + ',' + x.inner_id + ',' + "'" + x.Name + "'" + ');" data-bs-toggle="modal" data-bs-target="#raw_edit_instance_modal"></div><div class="col-sm-5">' + x.Name + '</div><div class="col-sm-2"style=""><h6 style="font-size:0.7rem;" id="' + x.inner_id + '_rating_quantities"></h6></div><div class="col-sm-1 rule float-end" id="' + x.inner_id + '_rating" data-toggle="tooltip" data-placement="top" title="Estimated resource consumption classification for this operation"></div></button></h2><div id="in' + x.inner_id + '_accordion" class="accordion-collapse collapse" aria-labelledby="in' + x.inner_id + '_header"><div class="accordion-body" id="' + x.inner_id + '_accordion_body"><div class="d-flex flex-column" id="' + x.inner_id + '_accordion_children"></div></div></div></div>';
        ...
        case 4: {
            ...
            for (let x in valid_instances) {
                dom_target_element.innerHTML += '<div class="accordion-item"><h2 class="accordion-header shadow-sm content_box_option" id="in' + valid_instances[x].inner_id + '_header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#in' + valid_instances[x].inner_id + '_accordion" aria-expanded="false" aria-controls="in' + valid_instances[x].inner_id + '_header" onClick="populateChildren(' + self_index + ',' + self_index + ',' + valid_instances[x].inner_id + ',false,false)"  style=""><div class="row text-center" style=""><div class="col-sm-1" style="z-index:2;"><a class="instance_delete" style="margin-left:auto;margin-right:auto;" data-toggle="tooltip" data-placement="bottom" title="" onclick="deleteInstance(' + self_index + ',' + self_index + ',' + valid_instances[x].inner_id + ',false,false)" data-bs-original-title="Delete instance "><strong>-</strong></a></div></div><div class="col-sm-1"><img src="res/edit.png" class="img-fluid" alt="Responsive image" width="60%" style="max-width:32px;padding-top:10px"data-toggle="tooltip" data-placement="bottom" title="Edit this element" onclick="prepareInstanceForEdition(' + self_index + ',' + valid_instances[x].inner_id + ',' + "'" + valid_instances[x].Name + "'" + ');" data-bs-toggle="modal" data-bs-target="#raw_edit_instance_modal"></div><div class="col-sm-7">' + valid_instances[x].Name + '</div></button></h2><div id="in' + valid_instances[x].inner_id + '_accordion" class="accordion-collapse collapse" aria-labelledby="in' + valid_instances[x].inner_id + '_header"><div class="accordion-body" id="' + valid_instances[x].inner_id + '_accordion_body"><div class="d-flex flex-column" id="' + valid_instances[x].inner_id + '_accordion_children"></div></div></div></div>'
...
function showVariableInput(variable_name, dom_target, current_value, is_variable_subset, parent_index, instance_id, is_instance, type, subset_name) {
    ...
    console.log(`For the variable: ${variable_name} the following configuration exists:\n ${JSON.stringify(customLayout)} \n and the variable is an instance: ${is_instance}`);


    if (customLayout == null) {
        alert("The property " + variable_name + " was not configured (it was empty), RADIANCE initialized it for you. Customize it the configuration builder. The builder will be reloaded after this alert to apply the automatic changes.");
    ...
    if (!customLayout.custom) {
        ...
        console.log(from + " no custom layout for the variable: " + variable_name);
        ...
        if (hide_variable) {
            ...
            try {
                if (custom_value_load != null && custom_value_load != '') {
                    ...
                    eval("let property_value ='" + String(available_parameters.current_value) + "'; let instance_id = " + instance_id + "; let parent_index = " + parent_index + "; " + custom_value_load);
                }
            } catch (e) {
                console.error("There was an error when interpreting the custom html handler for the property: " + custom_name + "\nThe preparation of the custom layout for it was skipped because: \n" + e + " in: " + custom_value_load);
                alertify.error("There was an error when interpreting the custom html handler for the property: " + custom_name + ".\n Open the console for more details.");
            }
    ...
    function verifyCustomLayout(variable_name) {
        console.log("Element count in the level configuration: " + this.temporal_level_data.length)
                        ...
                        if (this.external_triggers_cache[y].parent_profile.element_id == parent_profile) {
                            ...
                            for (let z in available_target_operations) {
                                if (this.external_triggers_cache[y].target_operation != null) {
                                    console.log("Trigger: Origin: "+JSON.stringify(origin));
    ...
    for (let x in this.collection_innheritance_tree) {
        ...
        for (let y in current_instance.collections) {
            ...
            if (!inheritance_diagram_two_objects.hasOwnProperty(current_object)) {
                ...
                //we check that it has a role as a child
        ...
        for (let y in current_branch) {
            ...
            if (x == 0) {//the first branch and member
                ...
                for (let z in children) {
                    ...
                    two_member.position.x = current_branch_member.position.x
                        - current_branch_member.width / 2
                        + two_member.width / 2
                        + z * two_member.width;
...
function interpreterInitialization() {
    ...
    if (this.db.hasOwnProperty("test_tube")) {
        ...
        console.log("No pre-existing test tube available, initializing it from 0: " + JSON.stringify(this.test_tube));
        this.test_tube = new Object();
    ...
    //This is old code and I do not remember how it is possible that a test_tube with a non-existing collection could be here, but let's filter it out.
    for (let x in this.test_tube.collections) {
        var found = false;
        for (let a in this.db.collection_Array) {
            console.log(this.db.collection_Array[a].element_id);
            if (this.db.collection_Array[a].element_id == this.test_tube.collections[x].root_id) {
                found = true;
                break;
            }
        }
        console.log(found);
        if (found == false) {
            //we remove the collection from the test tube
            this.test_tube.collections.splice(x, 1);
        }
    }
    ...
    for (let x in this.test_tube.collections) {
        ...
        //this is the document layout in an accordion element for the initialization of the profiles in a selected collection
        //removed from the debugging release:  id: '+root_id+' con: '+configuration_id+'
        ...
        var nested_collections = getCollectionInheritanceTree(collections_db[collection_position_in_db].element_id, [], 0);
            ...
            setTimeout(() => {
                ...
                if (profile_configuration != null) {
                    ...
                    for (let y in keys) {
                        ...
                        console.log("dom element value before change: " + dom_element ? dom_element.value : 'undefined');
                        if (dom_element) {
                            dom_element.value = key_value;
                            console.log("Dom element after change: " + dom_element.value);
                        }
                    }
                }
            }, 0); // Use a timeout to give the browser time to render the new elements
        ...
        if (collections_db[collection_position_in_db].inner_collections.length > 0) {
            ...
            for (let y in nested_collections) {
                if (nested_collections[y].parent == root_id) {
                    ...
                    console.log("HEY(1) (ROOTID:" + root_id + "" + JSON.stringify(nested_collections[y].collections));
                    console.log("target selection(2): " + JSON.stringify(nested_collections[y]));
                    for (let z in nested_collections[y].collections) {
                        var current_selection = nested_collections[y].collections[z];
                        console.log("Current child(A): " + nested_collections[y].collections[z]);
                        console.log('appending(B): ' + current_selection + ' to ' + target_dom);
                        console.log("Current child collection selection(C): " + current_selection + "\n" + JSON.stringify(nested_collections));
                        ...
                        //Good thing I can simplify it

                        setTimeout(() => {

                            let field_keys = Object.keys(collection_configuration_keys);
                            //we fetch the content
                            let values_location;
                            for (let u in this.test_tube.collections[x].content.collections) {
                                console.log("Inspecting the following collections for key values (Aa):" + JSON.stringify(this.test_tube.collections[x].content.collections));
                                if (this.test_tube.collections[x].content.collections[u].instance_id == current_selection) {
                                    //lets add the value once and for all
                                    console.log("Checking for match: " + this.test_tube.collections[x].content.collections[u].instance_id + " Current selection: \n" + current_selection);
                                    values_location = this.test_tube.collections[x].content.collections[u];

                                    break;

                                }
                            }
                            console.log("Valid location found (D): " + JSON.stringify(values_location));
                            for (let r in field_keys) {
                                //We update the value of each DOM object.
                                let current_key = field_keys[r];
                                let field = document.getElementById(configuration_id + '_' + current_selection + '_' + field_keys[r]);
                                //lets add the value once and for all

                                field.value = values_location[current_key];
                                console.log("Final value applied to " + current_key + " is: " + values_location[current_key]);

                            }
                            //information used:
                            console.log("Nested collections: " + JSON.stringify(nested_collections) + "\n Values Location" + JSON.stringify(values_location));

                        }, 0);
                    }
                } else {
                    console.log("ROOT id NOT THE SAME: " + root_id + " parent: " + nested_collections[y].parent);
                    ...
                    for (let z in nested_collections[y].collections) {
                        ...
                        console.log("Current child collection selection: " + current_selection);
