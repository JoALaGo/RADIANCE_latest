...
var inheritance_tree_branches = ['inheritance_tree_branch_1','inheritance_tree_branch_2','inheritance_tree_branch_3'];
...
function reInitializeCollectionsView() {
    ...
    diagram_dom_target.innerHTML = '';
    if(this.inheritance_diagram_two_objects!=null && this.inheritance_diagram_two_objects !=undefined){
        this.inheritance_diagram_two_objects = [];
    }
     if(this.inheritance_diagram!=null && this.inheritance_diagram !=undefined){
        this.inheritance_diagram = null;
    }
    this.inheritance_diagram = new Two().appendTo(diagram_dom_target);
    if(this.inheritance_diagram_branches!=null && this.inheritance_diagram_branches !=undefined){
        this.inheritance_diagram_branches = null;
    }
